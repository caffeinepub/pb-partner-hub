            ...
            <CardContent className="p-8 md:p-12">
              <div className="prose prose-lg max-w-none">
                <p className="text-lg text-muted-foreground leading-relaxed">
                  PB Partners Hub is a partner support platform created to
                  assist insurance partners associated with Policybazaar and PB
                  Partners.
                </p>
                <p className="text-lg text-muted-foreground leading-relaxed mt-6">
                  Our mission is to simplify insurance processes, provide timely
                  support, and help partners grow their business with confidence
                  and transparency.
                </p>
              </div>
            </CardContent>
            ...
            <Card className="border-2">
              <CardContent className="p-8">
                ...
                <p className="text-muted-foreground">
                  ...
                  dedicated support, clear communication, and continuous growth
                  opportunities.
                </p>
              </CardContent>
            </Card>
            <Card className="border-2">
              <CardContent className="p-8">
                ...
                <p className="text-muted-foreground">
                  ...
                  efficient support to all our insurance partners, helping them
