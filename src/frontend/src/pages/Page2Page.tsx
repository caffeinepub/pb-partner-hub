          ...
          <div className="max-w-4xl mx-auto text-center space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-lg text-muted-foreground md:text-xl max-w-3xl mx-auto">
                Complete motor insurance solutions for cars, bikes, and
                commercial vehicles with expert partner support, fast policy
        ...
        <div className="container">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              Comprehensive motor insurance support designed to help partners
          ...
          <div className="max-w-4xl mx-auto">
            <Card className="border-2">
              <CardHeader>
                ...
                <CardDescription className="text-base">
                  We provide end-to-end motor insurance support services to help
                  you serve your clients efficiently and grow your business.
                </CardDescription>
              </CardHeader>
                  ...
                  <ul className="space-y-3">
                    <li className="flex items-start gap-3">
                      ...
                      <span className="text-muted-foreground">
                        ...
                        motor insurance quotes for cars, bikes, and commercial
                        vehicles with competitive pricing from multiple
                        insurers.
                      </span>
                    </li>
                    <li className="flex items-start gap-3">
                      ...
                      <span className="text-muted-foreground">
                        ...
                        (RC Copy, Old Policy, PAN, Aadhaar, Contact Details).
                      </span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle className="h-5 w-5 text-primary mt-0.5 flex-shrink-0" />
                      <span className="text-muted-foreground">
                        ...
                        assistance including cashless garage network access,
                        claim documentation, and settlement tracking.
                      </span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle className="h-5 w-5 text-primary mt-0.5 flex-shrink-0" />
                      <span className="text-muted-foreground">
                        ...
                        continuous coverage for your clients.
                      </span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle className="h-5 w-5 text-primary mt-0.5 flex-shrink-0" />
                      <span className="text-muted-foreground">
                        ...
                        sessions on motor insurance products, policy features,
                        and sales techniques to boost your business.
                      </span>
                    </li>
                  </ul>
                </div>
        ...
        <div className="container">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              ...
              together to transform the motor insurance partner experience.
            </p>
          </div>
        ...
        <div className="container">
          <div className="max-w-3xl mx-auto text-center space-y-8">
            ...
            <p className="text-lg text-muted-foreground">
              Join PB Partners Hub today and get comprehensive motor insurance
