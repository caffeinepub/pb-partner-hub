      ...
      <section className="py-20 md:py-28">
        <div className="container max-w-4xl">
          ...
          <Alert className="mb-8">
            ...
            <AlertDescription>
              Please read this disclaimer carefully before using PB Partner
              Hub's website and services. By accessing or using our platform,
          ...
          <div className="prose prose-slate max-w-none space-y-8">
            <Card>
              ...
              <CardContent className="space-y-4 text-muted-foreground">
                <p>
                  The information provided by PB Partner Hub on our website and
                  through our services is for general informational purposes
            ...
            <Card>
              ...
              <CardContent className="space-y-4 text-muted-foreground">
                <p>
                  The information provided on PB Partner Hub is not intended to
                  be a substitute for professional advice. You should not rely
                  upon the information on our website as a basis for making any
                  business, legal, financial, or any other decisions.
                </p>
                <p>
                  While we strive to provide guidance and support for insurance
                  partners, we strongly recommend that you:
                </p>
                <ul className="list-disc pl-6 space-y-1">
                  <li>
                    Consult with qualified professionals for specific advice
                  </li>
            ...
            <Card>
              ...
              <CardContent className="space-y-4 text-muted-foreground">
                <p>
                  PB Partner Hub provides its website and services on an "as is"
                  and "as available" basis. We make no warranties, expressed or
            ...
            <Card>
              ...
              <CardContent className="space-y-4 text-muted-foreground">
                <p>
                  To the fullest extent permitted by applicable law, PB Partner
                  Hub, PBPartners (Policybazaar Insurance Broker Pvt. Ltd.), and
            ...
            <Card>
              ...
              <CardContent className="space-y-4 text-muted-foreground">
                <p>
                  ...
                  not provided or maintained by or in any way affiliated with PB
                  Partner Hub. Please note that we do not guarantee the
                ...
                <p>
                  ...
                  of those sites. The inclusion of any links does not
            ...
            <Card>
              ...
              <CardContent className="space-y-4 text-muted-foreground">
                <p>
                  While PB Partner Hub assists with partner onboarding and
                  compliance documentation, it is the sole responsibility of
                  each partner to:
                </p>
                <ul className="list-disc pl-6 space-y-1">
                  <li>
                  ...
                  <li>
                    Adhere to IRDAI (Insurance Regulatory and Development
                    Authority of India) guidelines
                  </li>
                  <li>Comply with all insurance industry standards</li>
                </ul>
                <p className="mt-4">
                  We do not guarantee that our services will ensure your
                  compliance with all applicable regulations. Partners are
            ...
            <Card>
              ...
              <CardContent className="space-y-4 text-muted-foreground">
                <p>
                  ...
                  available at all times. However, we do not guarantee
                  uninterrupted access or that the site will be free from
                  errors, viruses, or other harmful components.
                </p>
                <p>
                  We reserve the right to suspend, withdraw, or restrict the
                  availability of all or any part of our website or services for
            ...
            <Card>
              ...
              <CardContent className="space-y-4 text-muted-foreground">
                <p>
                  ...
                  our website is accurate and up-to-date, we cannot guarantee
                  its accuracy or completeness. The insurance industry is
                  subject to frequent changes in regulations, policies, and
                  procedures.
                </p>
                <p>
                  Partners should verify all information independently and not
                  rely solely on the information provided on our website for
            ...
            <Card>
              ...
              <CardContent className="space-y-4 text-muted-foreground">
                <p>
                  ...
                  third-party licensors. All statements and opinions expressed
                  in these materials are solely the opinions and responsibility
                  of the person or entity providing those materials.
                </p>
                <p>
                  These materials do not necessarily reflect the opinion of PB
                  Partner Hub. We are not responsible or liable to you or any
            ...
            <Card>
              ...
              <CardContent className="space-y-4 text-muted-foreground">
                <p>
                  PB Partner Hub reserves the right to modify, suspend, or
                  discontinue any aspect of our services at any time without
                  prior notice. We shall not be liable to you or any third party
            ...
            <Card>
              ...
              <CardContent className="space-y-4 text-muted-foreground">
                <p>
                  Despite our best efforts, our website may occasionally contain
                  inaccuracies or typographical errors. We do not warrant that
