...
export default function Page4Page() {
  return (
    <>
      <SEO
        title="Page 4"
        description="Page 4 of PB Partners Hub - Learn more about our commitment to insurance partner success."
        canonical="/page-4"
      />
      <div className="container py-12">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl font-bold text-foreground mb-6">Page 4</h1>
          
          <Card>
            <CardHeader>
              <CardTitle>Welcome to Page 4</CardTitle>
            </CardHeader>
            <CardContent>
